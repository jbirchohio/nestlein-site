...
document.addEventListener("DOMContentLoaded", () => {
  ...
  <div class="group perspective w-full max-w-sm mx-auto">
    <div class="flip-card group-hover:rotate-y-180 ${isTouch ? 'tap-flip' : ''}">
      <div class="flip-card-inner">
        ...
        <!-- Back -->
        <div class="card-back p-4 flex flex-col justify-center space-y-2 text-sm text-gray-800">
