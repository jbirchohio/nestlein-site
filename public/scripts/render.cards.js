document.addEventListener("DOMContentLoaded", () => {
  ...
  pillContainer.innerHTML = random.map(tag =>
    `<button class="tag-pill bg-white border border-orange-300 text-orange-600 px-4 py-1 rounded-full text-sm hover:bg-orange-200 transition" data-tag="${tag}">${tag}</button>`
  ).join("");
